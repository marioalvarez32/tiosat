...
// Source files:
// http://localhost:56607/sitio_internet/cfd/EstadoDeCuentaCombustible/ecc11.xsd
...
export interface EstadoDeCuentaCombustibleConceptosConceptoEstadoDeCuentaCombustible extends XastElement {
	...
	attributes: {
		...
		Importe: string;
		/** Atributo requerido para indicar la clave del producto del combustible.	**/
		NoIdentificacion: CClaveProducto;
 ...
 * @maxInclusive 2015-01-01T00:00:00
 **/
...
/** Clave del producto**/
export type CClaveProducto = '32011' | '32012' | '34006' | '34008' | 'Otros';
...
/** Catálogo Terminal de Almacenamiento y Reparto**/
export type CTAR =
	| '617'
	| '619'
	| '624'
