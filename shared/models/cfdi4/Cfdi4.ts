...
export class Cfdi4 {
  ...
  constructor(comprobante: any) {
    ...
    this.Certificado = comprobante.Certificado;
    this.CondicionesDePago = comprobante.CondicionesDePago;
    this.Confirmacion = comprobante.Confirmacion;
    this.Descuento = comprobante.Descuento;
    this.Folio = comprobante.Folio;
    this.NoCertificado = comprobante.NoCertificado;
    ...
    this.Exportacion = comprobante.Exportacion;
    ...
    this.Addenda = comprobante.Addenda;
    this.ComprobanteRelacionados = comprobante.ComprobanteRelacionados;
    this.Complemento = comprobante.Complemento;
    this.Conceptos = comprobante.Conceptos;
    this.Emisor = comprobante.Emisor;
    this.Impuestos = comprobante.Impuestos;
    this.InformacionGlobal = comprobante.InformacionGlobal;
    this.Receptor = comprobante.Receptor;
  }

  // private extractAttribute(attribute: string) {
  //   const extractedAttribute = comprobante.attributes[attribute];
