...
// Source files:
// http://localhost:56607/sitio_internet/cfd/Pagos/Pagos20.xsd
 ...
 **/
export interface BaseDR extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.000001
 **/
export type PagosPagoDoctoRelacionadoImpuestosDRRetencionesDRRetencionDRBaseDR = string;
 ...
 * @maxInclusive 0.000001
 **/
export type PagosPagoDoctoRelacionadoImpuestosDRTrasladosDRTrasladoDRBaseDR = string;
 ...
 **/
export interface BaseP extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
...
export interface PagosPagoDoctoRelacionado extends XastElement {
	...
	attributes: {
		...
		ObjetoImpDR: catCFDI.CObjetoImp;
	...
	children: PagosPagoDoctoRelacionadoImpuestosDR[];
}

/** Atributo condicional para expresar el tipo de cambio conforme con la moneda registrada en el documento relacionado. Es requerido cuando la moneda del documento relacionado es distinta de la moneda de pago. Se debe registrar el número de unidades de la moneda señalada en el documento relacionado que equivalen a una unidad de la moneda del pago. Por ejemplo: El documento relacionado se registra en USD. El pago se realiza por 100 EUR. Este atributo se registra como 1.0465711361 USD/EUR. El importe pagado equivale a 100 EUR * 1.0465711361 USD/EUR = 104.66 USD.
 * @maxInclusive 0.0000000001
 **/
export interface EquivalenciaDR extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.0000000001
 **/
export type PagosPagoDoctoRelacionadoEquivalenciaDR = string;
 ...
 * @maxInclusive 0.000000
 **/
export interface ImporteDR extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.000000
 **/
export interface ImporteP extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
...
export interface PagosPagoDoctoRelacionadoImpuestosDR extends XastElement {
	type: 'element';
	name: 'ImpuestosDR';
	children: (PagosPagoDoctoRelacionadoImpuestosDRRetencionesDR | PagosPagoDoctoRelacionadoImpuestosDRTrasladosDR)[];
}
...
export interface PagosPagoImpuestosP extends XastElement {
	type: 'element';
	name: 'ImpuestosP';
	children: (PagosPagoImpuestosPRetencionesP | PagosPagoImpuestosPTrasladosP)[];
}
 ...
 * @maxInclusive 0.00
 **/
export interface MontoTotalPagos extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
...
export interface PagosPago extends XastElement {
	...
	children: (PagosPagoDoctoRelacionado | PagosPagoImpuestosP)[];
}
...
export interface Pagos extends XastElement {
	...
	children: (PagosPago | PagosTotales)[];
}
...
export interface PagosPagoDoctoRelacionadoImpuestosDRRetencionesDRRetencionDR extends XastElement {
	type: 'element';
	name: 'RetencionDR';
	attributes: {
		/** Atributo requerido para señalar la base para el cálculo de la retención conforme al monto del pago, aplicable al documento relacionado, la determinación de la base se realiza de acuerdo con las disposiciones fiscales vigentes. No se permiten valores negativos.	**/
		...
		TipoFactorDR: catCFDI.CTipoFactor;
	};
...
export interface PagosPagoDoctoRelacionadoImpuestosDRRetencionesDR extends XastElement {
	type: 'element';
	name: 'RetencionesDR';
	children: PagosPagoDoctoRelacionadoImpuestosDRRetencionesDRRetencionDR[];
}
...
export interface PagosPagoImpuestosPRetencionesP extends XastElement {
	type: 'element';
	name: 'RetencionesP';
	children: PagosPagoImpuestosPRetencionesPRetencionP[];
}
...
export interface PagosPagoImpuestosPRetencionesPRetencionP extends XastElement {
	type: 'element';
	name: 'RetencionP';
	attributes: {
 ...
 * @maxInclusive 0.000000
 **/
export interface TasaOCuotaDR extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.000000
 **/
export type PagosPagoDoctoRelacionadoImpuestosDRRetencionesDRRetencionDRTasaOCuotaDR = string;
 ...
 * @maxInclusive 0.000000
 **/
export type PagosPagoDoctoRelacionadoImpuestosDRTrasladosDRTrasladoDRTasaOCuotaDR = string;
 ...
 * @maxInclusive 0.000000
 **/
export interface TasaOCuotaP extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.000000
 **/
export type PagosPagoImpuestosPTrasladosPTrasladoPTasaOCuotaP = string;
...
export interface PagosTotales extends XastElement {
	type: 'element';
	name: 'Totales';
	attributes: {
 ...
 * @maxInclusive 0.00
 **/
export interface TotalRetencionesIEPS extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalRetencionesISR extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalRetencionesIVA extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalTrasladosBaseIVA0 extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalTrasladosBaseIVA16 extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalTrasladosBaseIVA8 extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalTrasladosBaseIVAExento extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalTrasladosImpuestoIVA0 extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalTrasladosImpuestoIVA16 extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
 ...
 * @maxInclusive 0.00
 **/
export interface TotalTrasladosImpuestoIVA8 extends XastElement {
	name: string;
	children: [
		{
			type: 'text';
...
export interface PagosPagoDoctoRelacionadoImpuestosDRTrasladosDRTrasladoDR extends XastElement {
	type: 'element';
	name: 'TrasladoDR';
	attributes: {
		/** Atributo requerido para señalar la base para el cálculo del impuesto trasladado conforme al monto del pago, aplicable al documento relacionado, la determinación de la base se realiza de acuerdo con las disposiciones fiscales vigentes. No se permiten valores negativos.	**/
...
export interface PagosPagoImpuestosPTrasladosPTrasladoP extends XastElement {
	type: 'element';
	name: 'TrasladoP';
	attributes: {
		...
		TasaOCuotaP?: string;
		/** Atributo requerido para señalar la clave del tipo de factor que se aplica a la base del impuesto.	**/
		TipoFactorP: catCFDI.CTipoFactor;
	};
	/** XastElement is self-closing */
	children: [];
}
...
export interface PagosPagoDoctoRelacionadoImpuestosDRTrasladosDR extends XastElement {
	type: 'element';
	name: 'TrasladosDR';
	children: PagosPagoDoctoRelacionadoImpuestosDRTrasladosDRTrasladoDR[];
}
...
export interface PagosPagoImpuestosPTrasladosP extends XastElement {
	type: 'element';
	name: 'TrasladosP';
	children: PagosPagoImpuestosPTrasladosPTrasladoP[];
}
